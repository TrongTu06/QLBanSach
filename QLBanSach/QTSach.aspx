    ...
    <asp:GridView ID="gvSach" runat="server" CssClass="table table-bordered" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Chọn thao tác">
                <EditItemTemplate>
                    <asp:Button ID="btGhi" runat="server" Text="Ghi" CommandName="Update" CssClass="btn btn-sm btn-primary" />
                    <asp:Button ID="btKhong" runat="server" Text="Không" CommandName="Cancel" CssClass="btn btn-sm btn-secondary" />
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Button ID="btSua" runat="server" Text="Sửa" CommandName="Edit" CssClass="btn btn-sm btn-warning" />
